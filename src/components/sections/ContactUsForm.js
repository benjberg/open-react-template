...
} from "../sections/partials/Headings";
...
export default ({
  ...
  heading = (
    <>
      Feel free to <span tw="text-cool">get in touch</span>
      <wbr /> with us.
    </>
  ),
  description = "Have a question, maybe a suggestion, just want to say hi? Drop us a line!",
